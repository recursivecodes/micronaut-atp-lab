...
From your local machine, download the script, make it executable, and run it:
...
The script will produce a snippet used to run your application locally. It will look similar to this:
...
Before deploying, make sure you have run the snippet produced by `setup.sh` that looks similar to:
